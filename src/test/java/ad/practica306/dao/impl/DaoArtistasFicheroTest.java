...
public class DaoArtistasFicheroTest {
    ...
    public void testAgregarArtistaDuplicado() throws ExcepcionGestorArtista, RegistroDuplicado {
        Artista artista = new Artista("Nombre Artista", 2000.0, utilidadesArtista.convertStringToLocalDate("1985-05-10"));
        dao.agregarArtista(artista);
        dao.agregarArtista(artista); // Debe lanzar la excepción RegistroDuplicado
    }
