...
public class DaoArtistasMemoriaTest {

    private DaoArtistasMemoria daoArtistas;
    ...
    public void testAgregarArtistaDuplicado() throws Exception {
        Artista artista = new Artista("Frida Kahlo", 45000, utilidadesArtista.convertStringToLocalDate("1907-07-06"));
        daoArtistas.agregarArtista(artista);
        daoArtistas.agregarArtista(artista); // Debería lanzar RegistroDuplicado
    }
